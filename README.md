...
- **DAG-09** AI-slop scan: no em dashes, max one negation-pivot ("isn't just X, it's Y") per chapter, banned AI-ism phrase list ("delve", "tapestry", "a testament to", "it's important to note", ...), no emoji
